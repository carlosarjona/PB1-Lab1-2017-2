...
namespace prova.Controllers
{
    public class AutomovelController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "AutomovelId,Tipo,Descricao,Disponivel,DataCadastro")] Automovel automovel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "AutomovelId,Tipo,Descricao,Disponivel,DataCadastro")] Automovel automovel)
        {
            if (ModelState.IsValid)
            {
